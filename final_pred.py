...
class Application:
    ...
    def __init__(self):
        ...
        self.chart_label.place(x=1090, y=50)  # Adjust position for top-right placement


        self.panel = tk.Label(self.root)
        self.panel.place(x=50, y=50, width=480, height=400)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=600, y=50, width=400, height=400)

        self.T = tk.Label(self.root)
        self.T.place(x=20, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Cooper black", 20, "bold"))
        ...
        self.T3.place(x=10, y=510)
        self.T3.config(text="Sentence :", font=("Cooper black", 20, "bold"))

        # Label for "Translated Text :"
        self.T5 = tk.Label(self.root) 
        self.T5.place(x=10, y=560)
        self.T5.config(text="Kannada Text :", font=("Cooper Black", 20, "bold"))

        # Label for Kannada translation (place it beside T5)
        self.T6 = tk.Label(self.root, font=("Cooper Black", 20, "bold"))
        self.T6.place(x=280, y=560)  # Adjust x based on how long "Translated Text :" is
        
        # Label for Hindi translation (below Kannada translation)
        self.T7 = tk.Label(self.root, text="Hindi Text :", font=("Cooper Black", 20, "bold"))
        self.T7.place(x=10, y=610)

        self.T8 = tk.Label(self.root, font=("Cooper Black", 20, "bold"))
        self.T8.place(x=280, y=610)

        self.T9 = tk.Label(self.root)
        self.T9.place(x=10, y=660)
        self.T9.config(text="Suggestions :", fg="red", font=("Cooper black", 20, "bold"))
        ...
        self.translate_button.place(x=900, y=710)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\suhasini s hombal\\OneDrive\\Desktop\\Phase2 project major\\white.jpg")
                # img_final=img_final1=img_final2=0
    ...
    def clear_fun(self):
        ...
        self.word3 = " "
        self.word4 = " "
        self.panel5.config(text="")# Clear English translation
        self.T6.config(text="")# Clear Kannada translation
        self.T8.config(text="")# Hindi translation

    def translate_text(self):
        kannada_translation = translate_to_kannada(self.str)
        hindi_translation = translate_to_hindi(self.str)

        self.T6.config(text=kannada_translation)
        self.T8.config(text=hindi_translation)
