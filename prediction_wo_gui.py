...
model = load_model('C:\\Users\\suhasini s hombal\\OneDrive\\Desktop\\Phase2 project major\\cnn8grps_rad1_model.h5')
white = np.ones((400, 400), np.uint8) * 255
cv2.imwrite("C:\\Users\\suhasini s hombal\\OneDrive\\Desktop\\Phase2 project major\\white.jpg", white)

capture = cv2.VideoCapture(0)

hd = cvzone.HandTrackingModule.HandDetector()
hd2 = cvzone.HandTrackingModule.HandDetector()
...
while True:
    try:
        ...
        try:
            hands = hd.findHands(frame_rgb, draw=False, flipType=True)
